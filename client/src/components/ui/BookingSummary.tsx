        ...
        <div className='flex justify-between w-full py-2 '>
            ...
            <div className='w-1/4 text-right'>
                <Typography as="p" variant="small"
                            className={(seat) ? 'text-white-muted' : 'text-red'}>{(seat) ? seat : '...'}</Typography>
            </div>
        </div>
    )
}
            ...
            <div className="min-h-40 px-4 py-4 overflow-y-scroll w-full sm:px-6 lg:max-h-[calc(100vh-12.75rem)]">
                {(isBookingEmpty) ? (
                    <div className="w-full h-32 flex items-center justify-center">
                        <Typography as="p" variant="small" className="text-white/30 text-center max-w-40">Veuillez
                            sélectionner vos tickets et vos places</Typography>
                    </div>
                ) : (
                    <>
